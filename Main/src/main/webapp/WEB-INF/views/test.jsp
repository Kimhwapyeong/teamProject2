   ...
   */
   ...
   var boundary = new ol.layer.Tile({
    source: new ol.source.TileWMS({
            url: 'http://localhost:8090/geoserver/testpleasee/wms',
            params: {
                'LAYERS': 'testpleasee:youngin',
                'TILED': true,
            },
					...
					function showResult(result){
					    ...
					    var start_point = new ol.layer.Tile({
							...
							source: new ol.source.TileWMS({
						      url: 'http://localhost:8090/geoserver/testpleasee/wms',
						      params: {
						        'layers': 'testpleasee:Start_Point',
						        'tiled': 'true',
						        'VIEWPARAMS': 'date:'+selectedDay+';car_num:'+car_num
						      },
						      serverType: 'geoserver',
